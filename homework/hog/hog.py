...
def roll_dice(num_rolls, dice=six_sided):
    ...
    "*** YOUR CODE HERE ***"
    # END PROBLEM 1
    dices = [dice() for _ in range(num_rolls)]
    return 1 if 1 in dices else sum(dices)
...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    return abs(opponent_score // 10 % 10 - player_score % 10) * 3 or 1
    # END PROBLEM 2
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    return sus_points(player_score + boar_brawl(player_score, opponent_score)) if num_rolls == 0 \
        else sus_points(simple_update(num_rolls, player_score, opponent_score, dice))
    # END PROBLEM 4
