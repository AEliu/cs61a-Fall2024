class Transaction:
    ...
    def report(self):
        ...
        msg = 'no change'
        if self.changed():
            how_change = 'decreased' if self.before > self.after else 'increased'
            return f'{self.id}: {how_change} {self.before}->{self.after}'
            "*** YOUR CODE HERE ***"
...
class Mint:
    ...
    def update(self):
        "*** YOUR CODE HERE ***"
        self.year = __class__.present_year
